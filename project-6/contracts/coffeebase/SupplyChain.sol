...
contract SupplyChain {
  ...
  function harvestItem(uint _upc, address _originFarmerID, string _originFarmName, string _originFarmInformation, string  _originFarmLatitude, string  _originFarmLongitude, string  _productNotes) public 
  {
    ...
    items[_upc] = Item({sku: sku, upc: _upc, ownerID: owner, originFarmerID: _originFarmerID, originFarmName: _originFarmName, originFarmInformation: _originFarmInformation, originFarmLatitude: _originFarmLatitude, originFarmLongitude: _originFarmLongitude, productNotes: _productNotes, productID: _upc + sku, productPrice: 0, itemState: State.Harvested, distributorID: 0, retailerID: 0, consumerID: 0});
...
//  function processItem(uint _upc) harvested(_upc) verifyCaller(items[_upc].originFarmerID) public
  ...
  // function buyItem(uint _upc) forSale(_upc) public payable 
