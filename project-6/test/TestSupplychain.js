...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        // Verify the result set
        itemState = itemState + 1
        console.log("sellItem() upc=", upc, " resultBufferTwo[4].toNumber()=", resultBufferTwo[4])
        assert.equal(resultBufferTwo[0].toNumber(), sku, 'Error: Invalid item SKU')
        assert.equal(resultBufferTwo[1].toNumber(), upc, 'Error: Invalid item UPC')
        assert.equal(resultBufferTwo[2].toNumber(), productID, 'Error: Missing or Invalid productID')
        assert.equal(resultBufferTwo[3], productNotes, 'Error: Missing or Invalid productNotes')
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        console.log("sellItem() upc=", resultBufferTwoa[1], " resultBufferTwoa[4]=", resultBufferTwoa[4])
        ...
        console.log("upc=", upc)
        console.log("Account Contractor accounts[0]=",accounts[0]," balance=", balance)
        balance = await web3.eth.getBalance(accounts[1])
        console.log("Account Farmer accounts[1]=",accounts[1]," balance=", balance)
        distributerBalance = await web3.eth.getBalance(accounts[2])
        console.log("Account Distributor accounts[2]=",accounts[2]," distributerBalance=", distributerBalance)
        balance = await web3.eth.getBalance(accounts[3])
        console.log("Account Retailer accounts[3]=",accounts[3]," balance=", balance)
        balance = await web3.eth.getBalance(accounts[4])
        console.log("Account Consumer accounts[4]=",accounts[4]," balance=", balance)
        await supplyChain.buyItem(upc, {from: accounts[2], value: web3.utils.toWei("1", "ether")})
        ...
        // Verify the result set
         ...
         assert.equal(resultBufferTwo[6], accounts[2], 'Error: Invalid distributionID')
//         assert.equal(resultBufferTwo[7], accounts[3], 'Error: Invalid retailID')
//         assert.equal(resultBufferTwo[8], accounts[4], 'Error: Invalid consumerID')
         assert.equal(eventEmitted, true, 'Invalid event emitted')                 
    })    
